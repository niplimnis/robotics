# Παιχνίδι ανακύκλωσης με QR codes                                                                                                                                                 
...
Στο σημείο εκκίνησης του ρομπότ Edison («Σχολείο») είναι στοιβαγμένα τα απορρίμματα- έγχρωμες εικόνες ανακυκλώσιμων (από χαρτί, πλαστικό, γυαλί, αλουμίνιο, οργανικά απόβλητα) και μη ανακυκλώσιμων αντικειμένων (https://drive.google.com/file/d/1IxVkP2oz8rqSL1W4BrTWeEqgJk03K8FD/view?usp=sharing). 

Από εκεί ξεκινούν δύο δρόμοι διαφορετικής κατεύθυνσης.
...
Ο κάθε παίκτης, μέλος μιας ομάδας, παίρνει, από τα στοιβαγμένα απορρίμματα/εικόνες που βρίσκονται σε ένα κουτί μπροστά στο σχολείο, ένα καρτελάκι/εικόνα, το τοποθετεί πάνω στο ρομπότ και επιλέγει τη διαδρομή εκείνη που θα το οδηγήσει να πάει το αντικείμενο στον κατάλληλο κάδο. 
Επιπλέον, αν είναι ανακυκλώσιμο αντικείμενο, όταν φτάσει το ρομπότ στους 3 κάδους ανακύκλωσης, τότε καλείται να κάνει ορθή επιλογή κάδου. Όταν δυσκολεύεται «σαρώνει» το QR code για να βοηθηθεί.
...
https://youtu.be/rAWSq3-oe5Q

https://youtu.be/rAWSq3-oe5Q

https://youtu.be/aN-PVIZ2-K0

https://youtu.be/VjYc7M28czQ
...
Η βάση της μακέτας (πίστα) έγινε με άσπρο μακετόχαρτο. Πάνω σ’ αυτό κολλήσαμε χαρτόνι και τα παιδιά ζωγράφισαν τα οικοδομικά τετράγωνα,τους δρόμους, τα σοκάκια κλπ.

Τα σπίτια, κτίρια, κλπ. του χωριού έγιναν από χαρτόνια, χαρτόκουτα, πλαστικά κουτιά, μπουκάλια, playmobil κλπ.
Οι σκεπές των σπιτιών έγιναν από ανακυκλωμένο χαρτί που φτιάξαμε  στο σχολείο μας (https://youtu.be/8fUgmQ0VZvg).

# Ηλεκτρονικές συσκευές
•	Ρομπότ Edison V2.0 

•	Υπολογιστής ή tablet όπου θα γίνει ο προγραμματισμός με το λογισμικό EdBlocks (Το EdBlocks βασίζεται στο σύστημα drag and drop blocks και στη γλώσσα προγραμματισμού Scratch και Blockly, είναι δωρεάν και λειτουργεί σε υπολογιστή ή tablet https://www.edblocksapp.com/ )

•	Φορητή συσκευή, tablet ή κινητό, για τη "σάρωση" των QR codes

# Διάχυση / Επέκταση της δράσης
Η αφίσα (εικόνα της μακέτας), συνοδευόμενη με το μήνυμά μας, κοινοποιήθηκε στο Δήμο μας, στην ιστοσελίδα του σχολείου, στα τοπικά ΜΜΕ και στα μέσα κοινωνικής δικτύωσης, με σκοπό την ενεργοποίηση και ευαισθητοποίηση  των πολιτών ως προς την ανακύκλωση και ιδιαίτερα ως προς την ορθή κατανομή απορριμμάτων και επιπλέον ως πρόταση για υλοποίηση από τη Δημοτική αρχή.Μάλιστα ο ίδιος ο Δήμαρχος με προσωπική ευχαριστήρια επιστολή/απάντηση υποσχέθηκε ότι ως Δημοτική αρχή θα λάβουν σοβαρά υπόψιν την πρότασή μας.
